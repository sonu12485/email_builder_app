...
import { 
    edit_p, delete_item, edit_p_data, edit_layout, duplicate_item
...
class Edit_p extends Component 
{
    constructor(props)
    {
        ...
        // extract the data of paragraph to be edited and store it in states
        let x;
                   ...
                   <div className="row">
                     ...
                     <div className="col-sm-4">
                        <Button color="success" 
                            onClick={ () => this.props.edit_p() } className="btn-sm btn-block"
                        >DONE</Button>
                      </div>
                      <div className="col-sm-4">
                        <Button color="danger" 
